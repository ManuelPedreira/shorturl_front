import styles from "./ClipboardSVG.module.scss";

const ClipboardSVG = ({ check = false }: { check?: boolean }) => {
  return (
    <svg
      width="20px"
      height="20px"
    ...
    >
      ...
      {check ? (
        <path d="M9 13.4L10.7143 15L15 11" strokeLinecap="round" strokeLinejoin="round" />
      ) : (
        <>
          <path d="M8 14H16" strokeLinecap="round" />
          <path d="M7 10.5H17" strokeLinecap="round" />
          <path d="M9 17.5H15" strokeLinecap="round" />
        </>
      )}
